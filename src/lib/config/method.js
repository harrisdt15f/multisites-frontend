  ...
  ssc: {
    official: {
      ...
      WXZU60: {
        ...
        method: 'WXZU60',
        desc:
          '从“二重号”选择一个号码，“单号”中选择三个号码组成一注 ( 不与二重号相同 )',
        help:
      ...
      WXZU30: {
        ...
        method: 'WXZU30',
        desc:
          '从“二重号”选择两个号码，“单号”中选择一个号码组成一注 ( 不与二重号相同 )',
        help:
      ...
      WXZU20: {
        ...
        method: 'WXZU20',
        desc:
          '从“三重号”选择一个号码，“单号”中选择两个号码组成一注 ( 不与三重号相同 )',
        help:
      ...
      WXZU10: {
        ...
        method: 'WXZU10',
        desc:
          '从“三重号”选择一个号码，“二重号”中选择一个号码组成一注 ( 不与三重号相同 )',
        help:
      ...
      WXZU5: {
        ...
        method: 'WXZU5',
        desc:
          '从“四重号”选择一个号码，“单号”中选择一个号码组成一注 ( 不与四重号相同 )',
        help:
      ...
      SXZU12: {
        ...
        method: 'SXZU12',
        desc:
          '从“二重号”选择一个号码，“单号”中选择两个号码组成一注。( 不与二重号相同 )',
        help:
      ...
      SXZU4: {
        ...
        method: 'SXZU4',
        desc:
          '从“三重号”中选择一个号码，“单号”中选择一个号码组成一注。( 不与三重号相同 )',
        help:
      ...
      ZTS3: {
        ...
        desc: '选择一个号码形态。',
        help:
          '所选的号码特殊属性和开奖号码中间3位的属性一致，即为中奖。其中：1.豹子号的千、百、十位出现三个相同的号码；2.顺子号的千、百、十位不分顺序；3.对子号指的是开奖号码的中间三位当中，任意2位数字相同的三位数号码。',
        example:
      ...
      HTS3: {
        ...
        desc: '选择一个号码形态。',
        help:
          '所选的号码特殊属性和开奖号码后3位的属性一致，即为中奖。其中：1.豹子号的个、十、百位出现三个相同的号码；2.顺子号的个、十、百位不分顺序；3.对子号指的是开奖号码的后三位当中，任意2位数字相同的三位数号码。',
        example:
  ...
  lotto: {
    official: {
      ...
      LTDWD_1: {
        ...
        help:
          '从第一位任意选择1个号码，所选号码与相同位置上的开奖号码一致，即为中奖。',
      ...
      LTDWD_2: {
        ...
        help:
          '从第二位任意选择1个号码，所选号码与相同位置上的开奖号码一致，即为中奖。',
        example: '投注方案：第一位 01<br>开奖号码：01 * * * *，即中定位胆。',
        type: 'multi',
        layout: {
          第二位: lottoCodesTpl
      ...
      LTDWD_3: {
        ...
        help:
          '从第三位任意选择1个号码，所选号码与相同位置上的开奖号码一致，即为中奖。',
        example: '投注方案：第一位 01<br>开奖号码：01 * * * *，即中定位胆。',
        type: 'multi',
        layout: {
          第三位: lottoCodesTpl
  ...
  p3p5: {
    official: {
      ...
      QZX2: {
        ...
        help:
          '从0-9共10个号码中选择2个的号码组成一注，所选号码与当期顺序摇出的5个号码中的前2个号码相同，且顺序一致，即中奖。',
        example: '投注方案：58<br>开奖号码：前二位 58，即中前二直选。',
        type: 'multi',
        layout: {
          万位: digitalCodesTpl,
  ...
  pk10: {
    official: {
      ...
      PKQD3_S: {
        ...
        help:
          '手动输入第三名投注的1个号码与开奖号码中的第3位数号码相同，视为中奖。',
        example:
      ...
      PKQD4_S: {
        ...
        help:
          '手动输入第四名投注的1个号码与开奖号码中的第4位数号码相同，视为中奖。',
        example:
          '投注方案：01 <br>开奖号码为：* * * 01 * * * * * *，即中第四名复式.',
        type: 'text',
        number: 1,
      ...
      PKQZX4: {
        ...
        help:
          '从01-10共10个号码中选择4个不重复的号码组成一注，所选号码与当期顺序摇出的5个号码中的前4个号码相同，且顺序一致，即为中奖。',
        example:
      ...
      PKQZX4_S: {
        ...
        desc: '手动输入号码，至少输入1个四位数号码组成一注。',
        help:
          '手动输入4个号码组成一注，所输入的号码与当期顺序摇出的5个号码中的前4个号码相同，且顺序一致，即为中奖。',
        example:
          '投注方案：01 02 03 04<br>开奖号码：01 02 03 04 * * * * * *，即中第四名单式。',
        type: 'text',
        number: 4,
      ...
      PKQD5_S: {
        ...
        help:
          '手动输入第五名投注的1个号码与开奖号码中的第5位数号码相同，视为中奖。',
        example:
      ...
      PKQZX5: {
        ...
        help:
          '从01-10共10个号码中选择5个不重复的号码组成一注，所选号码与当期顺序摇出的5个号码中的前5个号码相同，且顺序一致，即为中奖。',
        example:
          '投注方案：01 02 03 04<br>开奖号码：01 02 03 04 * * * * * *，即中第四名单式。',
        type: 'multi',
        layout: {
      ...
      PKQZX5_S: {
        ...
        desc: '手动输入号码，至少输入1个五位数号码组成一注。',
        help:
          '手动输入5个号码组成一注，所输入的号码与当期顺序摇出的5个号码中的前5个号码相同，且顺序一致，即为中奖。',
        example:
