...
// 六合彩 生肖 特肖
const lhcTxCodesTpl = ['鼠', '马', '牛', '羊', '虎', '猴', '兔', '鸡', '龙', '狗', '蛇', '猪']
const lhcTxPosTpl = {
...
const pcDxdsCodesTpl    = ['大', '小', '单', '双', '大单', '大双', '小单', '小双', '极大', '极小', '豹子', '红波', '蓝波', '绿波']
    ...
    'ssc': {
        'official': {
            ...
            'WXZU60': {
                'name': '组选60',
                'method': 'WXZU60',
                'desc': '从“二重号”选择一个号码，“单号”中选择三个号码组成一注。',
            ...
            'WXZU30': {
                'name': '组选30',
                'method': 'WXZU30',
                'desc': '从“二重号”选择两个号码，“单号”中选择一个号码组成一注',
            ...
            'WXZU20': {
                'name': '组选20',
                'method': 'WXZU20',
                'desc': '从“三重号”选择一个号码，“单号”中选择两个号码组成一注',
            ...
            'WXZU10': {
                'name': '组选10',
                'method': 'WXZU10',
                'desc': '从“三重号”选择一个号码，“二重号”中选择一个号码组成一注',
            ...
            'WXZU5': {
                'name': '组选5',
                'method': 'WXZU5',
                'desc': '从“四重号”选择一个号码，“单号”中选择一个号码组成一注',
        ...
        'casino': {
            'CO_ZX_W': {
                ...
                'method': 'CO_ZX_W',
                'desc': '',
                'help': '当期开出的最后一位号码为特码。当开出特码与投注号码一致、即视为中奖（其余情况则视为不中奖）。',
                'example': '',
                'type': 'ylc',
                'layout': {
    ...
    'p3p5': {
        'official': {
            ...
            'QZX2': {
                ...
                'method': 'QZX2',
                'desc': '从第一位、第二位中至少各选择1个号码。',
                'help': '从0-9共10个号码中选择2个不重复的号码组成一注，所选号码与当期顺序摇出的5个号码中的前2个号码相同，且顺序一致，即中奖。',
                'example': '投注方案：58<br>开奖号码：前二位 58，即中前二直选。',
                'type': 'multi',
                'layout': {
                    '百位': digitalCodesTpl,
