...
export default {
    ...
    // PCDD
    T0(method, state) { return 1; },
    T1(method, state) { return 1; },
    T2(method, state) { return 1; },
    T3(method, state) { return 1; },
    T4(method, state) { return 1; },
    T5(method, state) { return 1; },
    T6(method, state) { return 1; },
    T7(method, state) { return 1; },
    T8(method, state) { return 1; },
    T9(method, state) { return 1; },
    T10(method, state) { return 1; },
    T12(method, state) { return 1; },
    T13(method, state) { return 1; },
    T14(method, state) { return 1; },
    T15(method, state) { return 1; },
    T16(method, state) { return 1; },
    T17(method, state) { return 1; },
    T18(method, state) { return 1; },
    T19(method, state) { return 1; },
    T20(method, state) { return 1; },
    T21(method, state) { return 1; },
    T22(method, state) { return 1; },
    T23(method, state) { return 1; },
    T24(method, state) { return 1; },
    T25(method, state) { return 1; },
    T26(method, state) { return 1; },
    T27(method, state) { return 1; },

    BIG(method, state) { return 1; },
    SMALL(method, state) { return 1; },
    ODD(method, state) { return 1; },
    EVEN(method, state) { return 1; },

    BIG_ODD(method, state) { return 1; },
    BIG_EVEN(method, state) { return 1; },
    SMALL_ODD(method, state) { return 1; },
    SMALL_EVEN(method, state) { return 1; },

    SUPER_BIG(method, state) { return 1; },
    SUPER_SMALL(method, state) { return 1; },
    BAOZI(method, state) { return 1; },
    RED_B(method, state) { return 1; },
    GREEN_B(method, state) { return 1; },
    BLUE_B(method, state) { return 1; },
}
