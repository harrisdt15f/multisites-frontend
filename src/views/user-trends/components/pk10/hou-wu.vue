    ...
    >
      <thead class="thead">
        <tr class="title-text">
          ...
          <th colspan="12" class="border-right border-bottom">第六名</th>
          <th colspan="12" class="border-right border-bottom">第七名</th>
          <th colspan="12" class="border-right border-bottom">第八名</th>
          <th colspan="12" class="border-right border-bottom">第九名</th>
          <th colspan="12" class="border-right border-bottom">第十名</th>
