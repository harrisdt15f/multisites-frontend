    ...
    >
      ...
      <tbody ref="chart-content" class="chart" :class="{'table-guides':showGuides}">
        ...
        >
          ...
          <!-- 号码分布 -->
          <td v-for="(ball, index1) in item[4]" :key="`${item[0]}${index1}`">
            <i class="ball-noraml" :class="`f-${ball[2]}`">{{ball[0] == 0 ? ball[1] : ball[0]}}</i>
          </td>
          <td class="ball-none border-right border-bottom"></td>
          <!-- 大小形态	 -->
          <td class="border-bottom">
            <template v-if="item[6] && item[6][0] == 1">大</template>
            <template v-if="item[6] && item[6][0] == 0">小</template>
          </td>
          <td class="border-right border-bottom">
            <template v-if="item[6] && item[6][1] == 1">大</template>
            <template v-if="item[6] && item[6][1] == 0">小</template>
          </td>
          <td class="ball-none border-bottom"></td>
          <!-- 单双形态	 -->
          <td class="border-bottom">
            <template v-if="item[7] && item[7][0] == 3">单</template>
            <template v-if="item[7] && item[7][0] == 2">双</template>
          </td>
          <td class="border-right border-bottom">
            <template v-if="item[7] && item[7][0] == 3">单</template>
            <template v-if="item[7] && item[7][0] == 2">双</template>
          ...
          <!-- 升平降形态 -->
          <td class="border-bottom">
            <template v-if="item[8] && item[8][0] == 3">降</template>
            <template v-if="item[8] && item[8][0] == 2">平</template>
            <template v-if="item[8] && item[8][0] == 1">升</template>
          </td>
          <td class="border-right border-bottom">
            <template v-if="item[8] && item[8][0] == 3">降</template>
            <template v-if="item[8] && item[8][0] == 2">平</template>
      ...
      <tbody class="tbody">
        <tr class="auxiliary-area">
          ...
          <template v-for="(items, index) in totalNum.slice(0, 3)">
        ...
        <tr class="auxiliary-area">
          ...
          <td class="ball-none border-bottom"></td>
          <td class="border-bottom"></td>
          <template v-for="(items, index) in omissionNum.slice(0, 3)">
            <td class="ball-none border-right border-bottom" :key="`${index}-ball`"></td>
            <td class="ball-none border-bottom" :key="`${index}-ball-bottom`"></td>
            <td class="border-bottom" v-for="(item, index1) in items" :key="`${index}-${index1}`">
              <i class="ball-noraml">{{item}}</i>
        ...
        <tr class="auxiliary-area">
          ...
          <td class="ball-none border-bottom"></td>
          <td class="border-bottom"></td>
          <template v-for="(items, index) in omissionMaxNum.slice(0, 3)">
            <td class="ball-none border-right border-bottom" :key="`${index}-ball`"></td>
            <td class="ball-none border-bottom" :key="`${index}-ball-bottom`"></td>
            <td class="border-bottom" v-for="(item, index1) in items" :key="`${index}-${index1}`">
              <i class="ball-noraml">{{item}}</i>
        ...
        <tr class="auxiliary-area">
          ...
          <td class="ball-none border-bottom"></td>
          <td class="border-bottom"></td>
          <template v-for="(items, index) in continuousNum.slice(0, 3)">
            <td class="ball-none border-right border-bottom" :key="`${index}-ball`"></td>
            <td class="ball-none border-bottom" :key="`${index}-ball-bottom`"></td>
            <td class="border-bottom" v-for="(item, index1) in items" :key="`${index}-${index1}`">
              <i class="ball-noraml">{{item}}</i>
