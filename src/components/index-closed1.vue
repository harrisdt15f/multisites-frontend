    ...
    <section class="w warp">
      ...
      <section class="fw lottery-info">
        ...
        <section class="lottery-notice lottery-hot">
          <section class="lottery-title lottery-title-hot">热门彩种</section>
          <ul class="fw lottery-notice-lists">
            <li class="lottery-notice-list">
              <section class="fw">
                <strong class="fl">
                  重庆时时彩
                  <span class="c51313">20190318</span>
                </strong>
                <p class="fr">
                  <span class="c51313">12</span>时
                  <span class="c51313">23</span>分
                  <span class="c51313">15</span>秒截止
                </p>
              </section>
              <section class="lottery-hot-bets">
                ...
                <section class="tc lottery-hot-multiples">
                  ...
                  <span class="lottery-hot-multiples-add dinv" @click="multiplesAdd()">+</span> 倍， 共
                  <span class="c51313"></span> 元
                </section>
              </section>
              <ul class="fw">
                <li class="lottery-hot-bets-select">
                  <i class="fa fa-refresh"></i>换一注
                </li>
      ...
      <section class="fw lottery-right">
        <section class="lottery-right-code">
          <img
            src="../assets/images/index/right-title.png"
            alt="微信二维码"
            title="微信二维码"
            class="lottery-right-code-title"
          >
          <img
            src="../assets/images/index/right-code.jpg"
            alt="微信二维码"
            title="微信二维码"
            class="lottery-right-code-img"
          >
        </section>
        <section class="lottery-wins">
          <img
            src="../assets/images/index/right-win.png"
            alt="中奖排行榜"
            title="中奖排行榜"
            class="lottery-right-win-img"
          >
