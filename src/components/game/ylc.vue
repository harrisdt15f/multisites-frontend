    ...
    <section class="fw ylc-content">
      <section class="ylc-content-left">
        ...
        >
          <!--娱乐城-->
          <template
            v-if="currentMethod.type === 'ylc' && currentMethod.method === 'ZH' || currentMethod.method === 'LMP'"
          >
            <section
              class="fl fw w16"
          ...
          <section class="tc" v-if="currentMethod.type === 'ylc' && currentMethod.method === 'LHD'">
            ...
            <section
              class="dinv ylc-lhd-list"
              v-for="(list, index) in pcdd.allCodeList.q"
              :key="index"
            >
              <h3 class="ylc-lhd-list-title">{{list.name}}</h3>
              <ul class="fw">
            ...
            <section
              class="dinv ylc-lhd-list"
              v-for="(list, index) in pcdd.allCodeList.b"
              :key="index"
            >
              <h3 class="ylc-lhd-list-title">{{list.name}}</h3>
              <ul class="fw">
            ...
            <section
              class="dinv ylc-lhd-list"
              v-for="(list, index) in pcdd.allCodeList.s"
              :key="index"
            >
              <h3 class="ylc-lhd-list-title">{{list.name}}</h3>
              <ul class="fw">
